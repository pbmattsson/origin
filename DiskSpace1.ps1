...
$html_file_dir = "R:\ATools\W12A_Stab (R21-R25)"
$server_file = "R:\ATools\W12A_Stab (R21-R25)\computers.txt"
$from_address = "UERack@something.com"
$to_address = "borje.mattsson@ericsson.com"
$email_gateway = "se-smtp.ericsson.se" # Can either be DNS name or IP address to SMTP server
