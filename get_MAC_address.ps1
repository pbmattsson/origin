...
Function Get-MacAddress {
	param($computername)
	Get-WmiObject "Win32_NetworkAdapterConfiguration" -computername $computername |	Where-Object {$_.IpEnabled -eq "TRUE"} |
	Select-Object DNSHostName,MACAddress,@{Name="IpAddress";Expression={$_.IPAddress}}	| 
	export-csv -path $resultdir\apa3.csv -Append -Delimiter ";" -NoTypeInformation
	}
